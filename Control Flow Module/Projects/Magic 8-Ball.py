...
name = input("Hi traveler, what is your name?")
# name = "DeWet"
# declare a variable name and assign it to the name of the person who will be asking the Magic 8-Ball.
question = input("What would you like to ask the magic 8-ball today?")
# declare a variable name and assign it to the name of the person who will be asking the Magic 8-Ball.
answer = ""
...
# Very doubtful.
    ...
    answer = "You won't like the outcome."
elif random_number == 11:
    answer = "Try not thinking about it."
elif random_number == 12:
    answer = "What are the odds, really?"
elif random_number == 13:
    answer = "Doesn't everybody."
elif random_number == 14:
    answer = "Answering your question with a question, won't you?"
elif random_number == 15:
    answer = "To be honest, not sure."
# Following the if/elif statements, add an else statement that will set answer to the string “Error”, if the number was accidentally assigned a value outside of our range.
    ...
    print("Error, supply a number from 1- 15")
...
if name != "" and question != "":
    ...
    print("How can I answer if you do not ask?")
